...
<html>
  ...
  <body>
    <p>🎯 Data Analyst in progress.</p>
    <p>📍 Puebla, Mexico.</p>
    <p>I focus on transforming raw data into actionable insights using Python, SQL, and data visualization tools. I'm open to collaboration opportunities (anytime &        anywhere & any type).</p>
    <div>
      <h4>🧠 About Me</h4>
      <p>📊 Passionate about data analysis and problem solving</p>
      <p>📈 Interested in business intelligence and decision-making</p> 
      <p>🚀 Currently improving my skills in data analysis and machine learning</p> 
    </div>
    <div>
      <h4>🛠️ Tech Stack</h4>
      <ul>
